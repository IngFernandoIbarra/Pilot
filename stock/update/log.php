...
//Respuestas de PILOT
create_log($directoryToLog . "/" . $bidFile . "/" . "Unidades" . "/" . "enviados" . "/" . $nameFile . "/" . $nameFile . "_unidad_actualizada.json", $arrayJson[2]);

//Informacion enviada a PILOT
create_log($directoryToLog . "/" . $bidFile . "/" . "Unidades" . "/" . $nameFile . "/" . $nameFile . "_unidad_actualizada.json", $arrayJson[3]);
